...
router.post('/', authMiddleware, authorize(['ADMIN']), validateResource(createTeacherSchema), teacherController.createTeacher);
// Bulk create teachers - Only admin can create teachers
router.post('/bulk', authMiddleware, authorize(['ADMIN']), teacherController.bulkCreateTeachers);
