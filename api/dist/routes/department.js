...
router.post('/', authMiddleware, authorize(['ADMIN']), validateResource(createDepartmentSchema), departmentController.createDepartment);
...
router.put('/:id', authMiddleware, authorize(['ADMIN']), validateResource(updateDepartmentSchema), departmentController.updateDepartment);
// Delete department - Only admin can delete departments
router.delete('/:id', authMiddleware, authorize(['ADMIN']), departmentController.deleteDepartment);
