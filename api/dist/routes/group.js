...
router.post('/', authMiddleware, authorize(['ADMIN']), validateResource(createGroupSchema), groupController.createGroup);
...
router.get('/department/:departmentId', authMiddleware, groupController.getGroupsByDepartment);
// Update group - Only admin can update groups
router.put('/:id', authMiddleware, authorize(['ADMIN']), validateResource(updateGroupSchema), groupController.updateGroup);
// Delete group - Only admin can delete groups
router.delete('/:id', authMiddleware, authorize(['ADMIN']), groupController.deleteGroup);
