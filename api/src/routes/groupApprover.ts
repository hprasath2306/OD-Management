...
router.post(
  ...
  authMiddleware,
  authorize(['ADMIN']),
  validateResource(createGroupApproverSchema),
  groupApproverController.createGroupApprover
);
...
router.get(
  '/',
  authMiddleware,
  groupApproverController.getAllGroupApprovers
);
...
router.get(
  '/:id',
  authMiddleware,
  groupApproverController.getGroupApproverById
);
...
router.get(
  '/group/:groupId',
  authMiddleware,
  groupApproverController.getGroupApproversByGroup
);
...
router.get(
  '/teacher/:teacherId',
  authMiddleware,
  groupApproverController.getGroupApproversByTeacher
);
...
router.put(
  ...
  authMiddleware,
  authorize(['ADMIN']),
  validateResource(updateGroupApproverSchema),
  groupApproverController.updateGroupApprover
);
...
router.delete(
  ...
  authMiddleware,
  authorize(['ADMIN']),
  groupApproverController.deleteGroupApprover
);
