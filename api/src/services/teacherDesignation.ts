...
export class TeacherDesignationService {
  ...
  async getAllTeacherDesignations(): Promise<TeacherDesignation[]> {
  ...
  async getTeacherDesignationById(id: string): Promise<TeacherDesignation | null> {
  ...
  async getTeacherDesignationsByTeacherId(teacherId: string): Promise<TeacherDesignation[]> {
    return await prisma.teacherDesignation.findMany({
      where: { teacherId },
      include: {
        teacher: true,
  ...
  async getTeacherDesignationsByDesignationId(designationId: string): Promise<TeacherDesignation[]> {
    return await prisma.teacherDesignation.findMany({
      where: { designationId },
      include: {
        teacher: true,
  ...
  async updateTeacherDesignation(
    id: string,
    data: {
      teacherId?: string;
      designationId?: string;
  ...
  async deleteTeacherDesignation(id: string): Promise<TeacherDesignation> {
