...
type AuthContextType = {
  ...
  isLoading: boolean;
  login: (email: string, password: string, checkOnly?: boolean, pushToken?: string) => Promise<any>;
  logout: () => Promise<void>;
...
export const AuthProvider = ({ children }: { children: ReactNode }) => {
  ...
  const login = async (email: string, password: string, checkOnly: boolean = false, pushToken?: string) => {
    try {
      setIsLoading(true);
